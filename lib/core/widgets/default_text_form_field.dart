...
import '../database_provider/app_services_database_provider.dart';
...
class _DefaultTextFormFieldState extends State<DefaultTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: TextStyle(
        color: widget.textColor ?? (AppServicesDBprovider.isDark() ? Colors.white : Colors.black),
      ),
        ...
        suffixIcon: widget.isPassword
            ? MaterialButton(
                ...
                onPressed: () {
                  setState(() {
                    isPass = !isPass;
                    suffix = isPass == false ? Icons.lock_outline : Icons.lock_open_rounded;
                  });
                },
                child: Icon(
                  suffix,
